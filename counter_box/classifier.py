...
class SkinCancerClassifier:
    ...
    def calculate_hausdorff(self, X):
        hausdorff_dimensions = []
        for img in tqdm(X):
            preprocessed_img = self.pr.process(img)
    ...
    def train(self, X_train, y_train):
            X_train_hausdorff = self.calculate_hausdorff(X_train)
    
            # Check for NaN values in X_train_hausdorff
            ...
            # Drop corresponding rows from X_train_hausdorff
    ...
    def predict(self, X_test):
        X_test_hausdorff = self.calculate_hausdorff(X_test)
    ...
    def evaluate(self, X_test, y_test):
        y_pred, nan_indices = self.predict(X_test)
